...
final class ClientController extends AbstractController
{
    ...
    #[Route('/client/proforma/{id}', name: 'app_client_proforma'), IsGranted('ROLE_SALE')]
    public function proformaById(ClientRepository $clientRepository, int $id): Response
    {
        $client = $clientRepository->find($id);
        $proformas = $client->getProformas()->toArray();

        return $this->render('client/proforma.html.twig', [
            'proformas' => $proformas,
            'client' => $client,
        ]);
    }

    #[Route('/client/bill/{id}', name: 'app_client_bill'), IsGranted('ROLE_SALE')]
    public function billById(ClientRepository $clientRepository, int $id): Response
    {
        $client = $clientRepository->find($id);
        $bills = $client->getBills()->toArray();

        return $this->render('client/bill.html.twig', [
            'bills' => $bills,
            'client' => $client,
        ]);
    }
