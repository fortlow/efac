...
class ProformaController extends AbstractController
{
    ...
    #[Route('/proforma', name: 'app_proforma'), IsGranted('ROLE_COMMERCIAL')]
    ...
    #[Route('/proforma/add', name: 'app_proforma_add'), IsGranted('ROLE_COMMERCIAL')]
    ...
    #[Route('/proforma/add/next/{id}/{mode}', name: 'app_proforma_add_next'), IsGranted('ROLE_COMMERCIAL')]
    ...
    #[Route('/proforma/edit/{id}', name: 'app_proforma_edit'), IsGranted('ROLE_COMMERCIAL')]
    ...
    #[Route('/proforma/delete/{id}', name: 'app_proforma_delete'), IsGranted('ROLE_GESTIONNAIRE')]
    ...
    #[Route('/proforma/transform/to/bill/{id}', name: 'app_proforma_transform_to_bill'), IsGranted('ROLE_COMMERCIAL')]
    ...
    #[Route('/proforma/view/{id}', name: 'app_proforma_view_proforma'), IsGranted('ROLE_COMMERCIAL')]
    ...
    #[Route('/proforma/view/proforma/test/{id}', name: 'app_proforma_view_proforma_test'), IsGranted('ROLE_COMMERCIAL')]
    ...
    #[Route('/proforma/send/proforma/{id}', name: 'app_proforma_send_proforma'), IsGranted('ROLE_COMMERCIAL')]
